...
<!-- PROCCESS GUIDE -->
<div <?php echo $maika_rfa != "true" ? "" : "style='display: none'"; ?> <?= $pass_guide_step === 2 ? "style='display: none'" : ""; ?> class="mt-8 mr-[20px] mx-auto px-8 py-6 text-base text-gray-800 rounded-lg bg-purple-200" role="alert">
