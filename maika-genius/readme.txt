...
Tags: chatgpt, openai, ai content, chatbot, live chat
...
- **Maika Sell ($59/month [cancel anytime] or $499/year [30% off]):**
	- Product Catalog Builder: Limit 5,000 sessions
...
- **Maika Genius ($299/month [cancel anytime] or $2499/year [30% off]):**
...
= [v1.5.2] =
- Minor UI for Chatbot Setup UX

= [v1.5.1] =
- New plugin name: Maika Genius — AI Content & Chatbot with ChatGPT and Gemini for WooCommerce
...
= [v1.1.0] =
- We're improving the plugin's UI with a more intuitive settings page and expanded customization options. Users will have a smoother experience, making adjustments faster and easier. 🚀

= [v1.0.3] =
- Fixed minor issues UI.
